<template>
  <el-form :model="form" :rules="rules" ref="formRef" label-width="150px" label-position="top" class="flex flex-wrap justify-between gap-1 my-10px mx-5px">
    <el-form-item :label="$t('common.name')" prop="name" class="min-w-[calc(40%-8px)]">
      <el-input v-model="form.name" />
    </el-form-item>
    <el-form-item :label="$t('common.phone')" prop="phone" class="min-w-[calc(60%-8px)]">
      <el-input v-model="form.phone" />
    </el-form-item>
    <el-form-item :label="$t('common.birthday')" prop="birth_date" class="min-w-[calc(30%-8px)]">
      <el-date-picker 
    ...
    <el-form-item :label="$t('common.email')" prop="email" class="min-w-[calc(60%-8px)]">
    ...
    <el-form-item class="flex-1 min-w-full">
      <el-button round type="primary" @click="handleSaveBasicInfo" :loading="saving" v-permission="'students.edit'">
        <template #icon>
          <div class="i-hugeicons:download-01" />
        </template>
        {{ $t('common.save') }}
      </el-button>
    </el-form-item>
