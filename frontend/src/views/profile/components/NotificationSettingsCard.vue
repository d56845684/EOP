    ...
    <template v-else-if="preferences">
      <div class="space-y-3">
        <div class="flex items-center justify-between rounded-xl border border-solid border-[#ebeef5] px-4 py-3">
          <div>
            <div class="font-medium">{{ $t('profile.notifications.emailEnabledTitle') }}</div>
        ...
        <div class="flex items-center justify-between rounded-xl border border-solid border-[#ebeef5] px-4 py-3">
          <div>
            <div class="font-medium">{{ $t('profile.notifications.bookingConfirmedTitle') }}</div>
            <div class="text-xs text-[var(--el-text-color-secondary)] mt-1">
        ...
        <div class="flex items-center justify-between rounded-xl border border-solid border-[#ebeef5] px-4 py-3">
          <div>
            <div class="font-medium">{{ $t('profile.notifications.bookingCancelledTitle') }}</div>
            <div class="text-xs text-[var(--el-text-color-secondary)] mt-1">
        ...
        <div class="flex items-center justify-between rounded-xl border border-solid border-[#ebeef5] px-4 py-3">
          <div>
            <div class="font-medium">{{ $t('profile.notifications.contractActivatedTitle') }}</div>
            <div class="text-xs text-[var(--el-text-color-secondary)] mt-1">
        ...
        <div class="flex items-center justify-between rounded-xl border border-solid border-[#ebeef5] px-4 py-3">
          <div>
            <div class="font-medium">{{ $t('profile.notifications.contractConvertedTitle') }}</div>
            <div class="text-xs text-[var(--el-text-color-secondary)] mt-1">
        ...
        <div class="flex items-center justify-between rounded-xl border border-solid border-[#ebeef5] px-4 py-3">
          <div>
            <div class="font-medium">{{ $t('profile.notifications.contractTerminatedTitle') }}</div>
            <div class="text-xs text-[var(--el-text-color-secondary)] mt-1">
