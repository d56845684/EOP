...
|------|--------|----------|--------|-----------|--------|
| **Domain 1 — BOOKING** | | | | | |
| `bookings.py` | 88 | 55 | 🟡 進行中 | 400100-400130, 403101-403108, 404101-404102, 409101-409102, 500101-500111, 502101 | — |
| `leave_records.py` | 33 | — | ⚪ 未開始 | — | — |
| `lesson_notes.py` | 12 | — | ⚪ 未開始 | — | — |
| `substitute_details.py` | 21 | — | ⚪ 未開始 | — | — |
| **Domain 2 — CONTRACT** | | | | | |
| `student_contracts.py` | 104 | — | ⚪ 未開始 | — | — |
